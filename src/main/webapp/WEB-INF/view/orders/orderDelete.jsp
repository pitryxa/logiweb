...
<c:set var="title" value="Delete order"/>
...
<main class="flex-shrink-0">
    <section class="container" id="content">
        ...
        <c:if test="${order.status != 'PREPARED'}">
            <div class="row">
                <div class="col">
                    <h5 class="text-center text-danger">The order cannot be deleted!</h5>
                </div>
            </div>
        </c:if>

        <c:if test="${order.status == 'PREPARED'}">
            <form action="${contextPath}/officer/orders/delete" method="post">
