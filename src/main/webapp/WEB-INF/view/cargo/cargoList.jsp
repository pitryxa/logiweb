        ...
        <table class="table table-striped">
            ...
            <c:forEach var="cargo" items="${cargoList}">
                <tr>
                    ...
                    <td>${cargo.cityTo}</td>
                    <td class="action">
                        <a href="${contextPath}/officer/cargo/edit/${cargo.id}" class="text-decoration-none" title="edit">
...
<%--                        <a href="${contextPath}/officer/cargo/delete/${cargo.id}" class="text-decoration-none" title="delete">--%>
