...
<%--                <th data-field="action">Action</th>--%>
            ...
            <c:forEach var="city" items="${cityList}" varStatus="counter">
                <tr>
                    ...
                    <td>${city.name}</td>
<%--                    <td class="action">--%>
<%--                        <a href="${contextPath}/admin/city/edit/${city.id}" class="text-decoration-none" title="edit">--%>
...
<%--                            </svg>--%>
<%--                        </a>--%>
<%--                        &lt;%&ndash;<a href="${contextPath}/city/delete/${city.id}" class="text-decoration-none" title="delete">--%>
