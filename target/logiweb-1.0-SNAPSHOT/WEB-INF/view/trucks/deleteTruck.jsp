...
<main class="flex-shrink-0">
    <section class="container form-content" id="content">
        <div class="row" id="nameSection">
            <div class="col">
                <h4 class="text-center text-cadetblue">${title} #${truck.id}</h4>
            </div>
        </div>
        ...
        <form action="/officer/trucks/delete" method="post">
            ...
            <div class="form-group row">
                ...
                <input type="text" name="shiftSize" id="shiftSize" value="${truck.shiftSize}" class="form-control col-sm-10" readonly>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <input type="text" name="city" id="city" value="${truck.city}" class="form-control col-sm-10" readonly>
            </div>
